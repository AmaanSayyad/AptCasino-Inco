export const gameData = {
  ...
  paragraphs: [
    ...
    'Every drop settles through Inco Lightning confidential randomness and AptCasino.sol on Base Sepolia — the bucket a ball lands in is verifiable on-chain, never picked by the browser.',
  ...
  options: [
    {
      ...
      bets: [
        { name: 'Low Risk', description: 'Conservative betting with steady returns', payout: '0.1x - 4x' },
        { name: 'Medium Risk', description: 'Balanced risk and reward', payout: '0.05x - 8x' },
        { name: 'High Risk', description: 'High risk for maximum rewards', payout: '0.01x - 16x' },
      ],
    },
    {
