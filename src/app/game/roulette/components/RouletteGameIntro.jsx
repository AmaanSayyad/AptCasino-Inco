...
const HIGHLIGHTS = [
  ...
  {
    icon: FaShieldAlt,
    title: 'Inco-verified fair',
    body: 'Verifiable on-chain randomness on Base Sepolia — every spin settles with a real attested transaction.',
  ...
  },
  {
    icon: FaDice,
    title: 'Up to 35:1',
    body: 'Straight-up numbers, splits, streets, corners, six-lines, dozens, red/black — mix inside and outside bets.',
...
const CHIPS = ['37 pockets', '2.7% edge', '35:1 max', 'Base Sepolia'];
      ...
      <div className="relative flex flex-col rounded-2xl border border-purple-700/30 bg-gradient-to-br from-[#1A0015]/95 to-[#0d0008]/90 p-5 sm:p-6 lg:p-7 text-gray-300 shadow-[0_10px_30px_rgba(0,0,0,0.5)] overflow-hidden">
        ...
        <div className="flex items-start gap-4 mb-6 pt-1">
          ...
          <div className="min-w-0">
            ...
            <p className="text-sm text-white/55 mt-1">Classic wheel · Inco-confidential · Base Sepolia</p>
          </div>
        </div>
