...
const STEPS = [
  {
    ...
    icon: FaBolt,
    title: 'Register',
    desc: 'Connect your wallet and pay the USDC entry fee to join the active Volume Cup.',
  },
  {
    n: 2,
    icon: FaGamepad,
  ...
  },
  {
    ...
    icon: FaMedal,
    title: 'Win',
    desc: 'Top wallets by wagered volume share the USDC prize pool.',
  },
];
...
export default function CompetitionPage() {
  return (
    <PageShell
      ...
      title="Volume Cup"
      description="Seasonal wager-volume tournaments on Base Sepolia. Register with USDC, play qualifying games with the same wallet, and climb the standings for USDC prizes."
      maxWidth="6xl"
