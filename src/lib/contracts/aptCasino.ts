...
export const aptCasinoAbi = parseAbi([
  ...
  'function revealTiles(uint256 gameId, uint8[] tiles) returns (bool hitMine)',
...
export const rewardVaultAbi = parseAbi([
  ...
  'function claimTicketWithInviter(address inviter) returns (uint256 ticketId)',
  'function claimTicketFor(address player, address inviter) returns (uint256 ticketId)',
