...
function assertSafeHlsHost(hostname) {
...
function manifestUrlForPlaybackId(playbackId, origin = LIVEPEER_CDN_ORIGIN) {
 ...
 */
function resolveSafeHlsManifestUrl(input) {
...
export async function validateLivepeerOrHls(playbackId) {
  let hls;
  try {
...
export function streamSourceType(playbackId) {
