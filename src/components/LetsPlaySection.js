...
const TRUST = ['Inco Lightning', 'Base Sepolia', 'Megapot tickets'];
          ...
          <div className="overflow-hidden rounded-2xl bg-[#0a0008]/95 px-6 py-10 sm:px-10 sm:py-12">
            <div className="flex flex-col items-center text-center">
              ...
              <p className="mt-4 max-w-xl text-[15px] leading-relaxed text-white/55 sm:text-base">
                Connect a Base wallet, choose a confidential game, and settle the hidden outcome with an Inco
                attestation. Every completed round advances your Megapot ticket progress.
              </p>

              {/* Chain pills */}
              <div className="mt-6 flex flex-wrap items-center justify-center gap-2">
                {['Base Sepolia', 'Inco Lightning', 'Megapot'].map((label) => (
                  <span
                    key={label}
                  ...
                  >
                    <span className="flex h-4 w-4 items-center justify-center rounded-full bg-gradient-to-br from-red-magic to-blue-magic text-[8px] font-black text-white">{label[0]}</span>
                    {label}
              ...
              <div className="mt-8 grid w-full max-w-2xl grid-cols-1 gap-3 sm:grid-cols-2">
                <StatTile
                  ...
                  label="Live games"
                  value={4}
                  sub="Roulette · Wheel · Plinko · Mines"
