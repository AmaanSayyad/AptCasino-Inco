...
const APT_CASINO = [
  'Confidential Inco randomness',
  'Megapot tickets earned by playing',
  'Attested on-chain settlement',
...
const FEATURES = [
  {
    ...
    description:
      'Inco Lightning keeps the random outcome confidential until its attested on-chain reveal.',
    icon: Shield,
  ...
  {
    id: 2,
    title: 'Megapot Progression',
    description:
      'Every settled game earns credits that convert into Megapot ticket NFTs inside the core loop.',
    icon: Link2,
      ...
      <div className="relative z-10 mx-auto max-w-7xl">
        ...
        <div className="mb-10 flex items-center justify-center gap-3 sm:justify-start">
          ...
          <div className="text-center sm:text-left">
            ...
            <p className="mt-1 text-sm text-white/50">Confidential gaming, Base settlement, and real Megapot tickets</p>
          </div>
        </div>
              ...
              {!imageError ? (
                <>
                  ...
                  <div className="absolute bottom-4 left-4 right-4">
                    ...
                    <p className="mt-0.5 text-sm font-medium text-white/90">Play privately on Base Sepolia</p>
                  </div>
                </>
              ) : (
            ...
            <div className="flex h-full flex-col rounded-2xl border border-white/10 bg-gradient-to-br from-white/[0.06] to-white/[0.02] p-6 backdrop-blur-sm sm:p-8">
              ...
              <div className="mt-6 flex flex-wrap items-center gap-3 border-t border-white/10 pt-5">
                <span className="inline-flex items-center gap-1.5 rounded-full border border-emerald-500/25 bg-emerald-500/10 px-2.5 py-1 text-[11px] font-medium text-emerald-300">
                  <span className="flex h-3.5 w-3.5 items-center justify-center rounded-full bg-blue-500 text-[8px] font-black text-white">B</span>
                  Base Sepolia
                </span>
                <span className="inline-flex items-center gap-1.5 rounded-full border border-sky-500/25 bg-sky-500/10 px-2.5 py-1 text-[11px] font-medium text-sky-300">
                  <span className="flex h-3.5 w-3.5 items-center justify-center rounded-full bg-fuchsia-500 text-[8px] font-black text-white">I</span>
                  Inco Lightning
                </span>
                <p className="min-w-[200px] flex-1 text-xs leading-relaxed text-white/50 sm:text-sm">
                  Settled rounds award credits that can be redeemed for Megapot tickets.
                </p>
              </div>
            </div>
          </div>
